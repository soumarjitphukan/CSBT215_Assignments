...
public class AP_A6 {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student(1, "Rajiv",
                Arrays.asList("DAA", "CAO"), scores1));

        students.add(new Student(2, "Bornil",
                Arrays.asList("DAA", "AP"), scores2));

        students.add(new Student(3, "Kauztav",
                Arrays.asList("DAA", "AP"), scores3));
